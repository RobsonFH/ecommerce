...
function Cart() {
  ...
  return (
    <Layout>
      ...
      >
        <h1 className="mb-10 text-center text-2xl font-bold">Carrinho</h1>
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          >
            ...
            <button onClick={buyNow}
              type="button"
              className="focus:outline-none text-white bg-blue-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm w-full  py-2"
            >
              Comprar
            </button>
          </div>
